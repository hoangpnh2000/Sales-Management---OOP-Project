...
public class HomeFrm extends javax.swing.JFrame implements View {
	...
	private void initComponents() {
		...
		tblHoaDon.setModel(new DefaultTableModel(new Object[][] { { null, null, null, null, null, null, null, null }, },
				new String[] { "Date", "Product's ID", "Product's Name", "Customer's ID", "Customer's Name", "Price",
				...
				if (check.length() > 0 && date.length() > 0) {
					if (month <= 12) {
						if ((month == 1 || month == 3 || month == 5 || month == 7 || month == 8 || month == 10
							...
							JOptionPane.showMessageDialog(rootPane, "Date is error");
							count = 2;
						}

					} else {
						JOptionPane.showMessageDialog(rootPane, "Month is error");
						count = 2;
					...
					if (count == 5) {
						...
						if (KHIndex == -1 || MHIndex == -1) {
							JOptionPane.showMessageDialog(rootPane, "Please choose one customer and product");
		...
		tblKH = new JTable();
		tblKH.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "ID", "Customer's Name" }));
		...
		tblMH = new JTable();
		tblMH.setModel(new DefaultTableModel(new Object[][] { { null, null, null }, },
				new String[] { "ID", "Product's Name", "Price" }));
		...
		comboSortHD.setModel(
				new DefaultComboBoxModel(new String[] { "Date", "Product's Name", "Customer's Name", "Total" }));
